...
import './Ads.css'
import {showAdsModal, showSaleDetailModal} from "../../../redux/actions/modal";
import 'react-contexify/dist/ReactContexify.min.css'
import '@styles/react/libs/context-menu/context-menu.scss'
import {CreateAds} from "../../modals/CreateAds/CreateAds";
...
const Ads = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: row => {
                return (
                    <div>
                        <div>
                            {isActive[row.status === 'active']?.icon}&nbsp;&nbsp;&nbsp;
                            {row.status === 'active' && <span style={{color: "#00AB5F"}}>Active</span>}
                            {row.status !== 'active' && <span style={{color: "#FC7753"}}>Inactive</span>}
                        </div>
                    </div>
                )
            }
        },
        {
            ...
            cell: row => {
                return (
                    <div className="d-flex align-items-center">
                        <a className="datatable-id-column" href={row.linkURL}>{row.linkURL}</a>
                    </div>
                )
            }
        },
    ...
    useEffect(async () => {
        const res = await axios.get('/adsManager/overview')
        if (res) {
    ...
    const loadData = async () => {
        ...
        try {
            response = await axios.post('/adsManager/getAllAds', {pageNumber, pageSize, searchStr, sort})
        } catch (e) {
        ...
        <Fragment>
                ...
                <div className="row mt-1">
                    <div className="col-4 d-flex align-items-center">
                        ...
                        <div className="d-block ml-1">
                            <p className="sale-sub-overview" style={{marginBottom: 3}}>{overViewData?.allAdsCount}</p>
                            <p className="sale-sub-cus mb-0">All Ads</p>
                        </div>
                    </div>
                    <div className="col-4 d-flex align-items-center">
                        <svg width="40" height="41" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="d-block ml-1">
                            <p className="sale-sub-overview"
                               style={{marginBottom: 3}}>₦{overViewData?.activeAdsCount}</p>
                            <p className="sale-sub-cus mb-0">Active Ads</p>
                        </div>
                    </div>
                    <div className="col-4 d-flex align-items-center">
                        <svg width="40" height="41" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="d-block ml-1">
                            <p className="sale-sub-overview"
                               style={{marginBottom: 3}}>{overViewData?.inactiveAdsCount}</p>
                            <p className="sale-sub-cus mb-0">Inactive Ads</p>
                        </div>
                    </div>
                </div>
            </Card>
            <Card>
                <CardHeader className='flex-md-row flex-column align-md-items-center align-items-start border-bottom'>
                    ...
                    <Button className='ml-2' color='primary' onClick={() => dispatch(showAdsModal(true))}>
                        <PlusCircle size={15}/>
                        <span className='align-middle ml-50'>Create Ads</span>
                    </Button>
                </CardHeader>
