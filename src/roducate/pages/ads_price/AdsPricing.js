...
import {showAdsModal, showAdsPricingModal, showSaleDetailModal} from "../../../redux/actions/modal";
import 'react-contexify/dist/ReactContexify.min.css'
import '@styles/react/libs/context-menu/context-menu.scss'
import Avatar from "../../../@core/components/avatar";
import {CreateAdsPricing} from "../../modals/CreateAdsPricing/CreateAdsPricing";
...
const AdsPricing = () => {
    ...
    const loadData = async () => {
        ...
        try {
            response = await axios.post('/adsManager/adsPrice/getAllAdsPrice', {pageNumber, pageSize, searchStr, sort})
        } catch (e) {
        ...
        <Fragment>
            <Card>
                <CardHeader className='flex-md-row flex-column align-md-items-center align-items-start border-bottom'>
                    ...
                    <Button className='ml-2' color='primary' onClick={() => dispatch(showAdsPricingModal(true))}>
                        <PlusCircle size={15}/>
                        <span className='align-middle ml-50'>Create Pricing</span>
                    </Button>
                </CardHeader>
