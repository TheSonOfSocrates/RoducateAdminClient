...
const UploadVideoComp = ({onRowSelected}) => {
    ...
    const loadData = async () => {
        ...
        try {
            response = await axios.post('/resource/videoStore/getAll', {
                pageNumber,
                pageSize,
                searchStr,
                sort
        ...
        if (response && response.data.success) {
            setTotalPages(response.data.videoStoreList.totalPages)
            setDataList(response.data.videoStoreList.data)
        }
