...
// ** Styles
import './InActiveStatComp.css'
import {LineSeries, XYPlot} from "react-vis";
import React, {useEffect, useState} from "react";
import axios from "../../../utility/axios";

const InActiveStatComp = props => {
    // ** Props
    const {
        msg,
        time,
    ...
    return (
        <div>
            <div className="d-flex justify-content-between mb-2">
                <div>
                    <span style={{color: '#FCB22B'}}>Inactive</span>&nbsp;&nbsp;
            ...
            <div>
                <div className="d-flex align-items-center">
                    <span className="number-count">{overViewData?.inactiveSchoolCount}</span>&nbsp;&nbsp;
                    <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
...
export default InActiveStatComp

// ** PropTypes
InActiveStatComp.propTypes = {
