...
import './UppyFileUploader.css'

const CustomUppyFileUploader = ({onFileChange, multi = false, currentImgs}) => {
    ...
    const renderPreview = () => {
        if (isUploading) {
            ...
            return currentImgs?.map((img, index) => <div className={`${multi ? 'col-4' : 'col-12'}`}
                                                         style={{height: '150px', padding: 0}}><img
...
export default CustomUppyFileUploader
