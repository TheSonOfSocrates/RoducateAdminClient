...
export const showLoadingScreen = isShowLoadingScreen => dispatch => dispatch({ type: 'showLoadingScreen', isShowLoadingScreen })

export const setCurrentLanguage = setCurrentLanguage => dispatch => dispatch({ type: 'setCurrentLanguage', setCurrentLanguage })