...
import {handleSearchQuery, updateBookmarked} from '@store/actions/navbar'
import {SizeTextfieldStateWrapper} from "../../../../roducate/components/SizeTextfieldState";
import "./NavbarBookmarks.css"
import {showSearchMenuModal} from "../../../../redux/actions/modal";
import {SearchMenuModal} from "../../../../roducate/modals/SearchMenuModal/SearchMenuModal";
...
const NavbarBookmarks = props => {
    ...
    const handleBookmarkVisibility = () => {
        dispatch(showSearchMenuModal(true))
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    ...
                                                    {item.icon}
                                                    <span className='text-truncate ml-1'>{item.title}</span>
                                                </div>
                                            </Link>
                                            {/*<Icon.Star*/}
                                            {/*    size={17.5}*/}
