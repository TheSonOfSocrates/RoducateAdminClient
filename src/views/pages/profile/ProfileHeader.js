...
import {Button, Card, CardImg, Collapse, Nav, Navbar, NavItem, NavLink} from 'reactstrap'
            ...
            <div className='position-relative'>
                <div className='profile-img-container d-flex align-items-center'>
                    <div className='profile-img'>
                        <img className='rounded img-fluid' src={`${process.env.REACT_APP_3BUCKET_URL}${data.avatar}`}
                             alt='Card image'/>
                    </div>
